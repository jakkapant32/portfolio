  ...
  return (
    <section id="home" className="min-h-screen flex flex-col md:flex-row md:items-center px-6 md:px-[72px] pt-[120px] pb-20 relative">
      ...
      <div className="max-w-[680px] relative z-10">
        <ScrollReveal>
          <div className="inline-flex items-center gap-2 bg-[var(--white)] border border-[var(--border)] rounded-[100px] py-1.5 pl-2.5 pr-4 mb-10 text-xs font-medium text-[var(--mid)] shadow-[0_2px_12px_rgba(27,45,94,0.06)]">
        ...
        <ScrollReveal>
          <h1 className="text-[clamp(2.5rem,5vw,4rem)] font-bold text-[var(--navy)] leading-tight tracking-tight mb-6">
            Jakkapan
            <br />
            <span className="font-light text-[var(--sky)] italic">Chinsopa</span>
          </h1>
        </ScrollReveal>
        <ScrollReveal>
      ...
      <ScrollReveal className="relative z-10 md:absolute md:right-[72px] md:top-1/2 md:-translate-y-1/2 flex flex-row flex-wrap md:flex-col gap-4 mt-10 md:mt-0">
        <div className="bg-[var(--white)] border border-[var(--border)] rounded-2xl p-5 min-w-[140px] shadow-[0_4px_20px_rgba(27,45,94,0.07)] hover:shadow-[0_10px_30px_rgba(27,45,94,0.12)] hover:-translate-y-0.5 transition-all">
          <div className="text-[32px] font-bold text-[var(--navy)] leading-none mb-1 tracking-tight">3<span className="text-[var(--sky)] font-normal text-xl">.95</span></div>
          <div className="text-[11px] text-[var(--muted)]">{t.statGpa}</div>
        </div>
        <div className="bg-[var(--white)] border border-[var(--border)] rounded-2xl p-5 min-w-[140px] shadow-[0_4px_20px_rgba(27,45,94,0.07)] hover:shadow-[0_10px_30px_rgba(27,45,94,0.12)] hover:-translate-y-0.5 transition-all">
          <div className="text-[32px] font-bold text-[var(--navy)] leading-none mb-1 tracking-tight">100<span className="text-[var(--sky)] font-normal text-xl">+</span></div>
          <div className="text-[11px] text-[var(--muted)]">{t.statClients}</div>
        </div>
        <div className="bg-[var(--white)] border border-[var(--border)] rounded-2xl p-5 min-w-[140px] shadow-[0_4px_20px_rgba(27,45,94,0.07)] hover:shadow-[0_10px_30px_rgba(27,45,94,0.12)] hover:-translate-y-0.5 transition-all">
          <div className="text-[32px] font-bold text-[var(--navy)] leading-none mb-1 tracking-tight">3<span className="text-[var(--sky)] font-normal text-xl">+</span></div>
          <div className="text-[11px] text-[var(--muted)]">{t.statYears}</div>
        </div>
      </ScrollReveal>
    </section>
  )
